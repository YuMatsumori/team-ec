package jp.co.internous.team2502.model.mapper;
...
import jp.co.internous.team2502.model.domain.MstDestination;
...
public interface MstDestinationMapper {
	 ...
	 * @return 登録件数
	 */
	@Insert("INSERT INTO mst_destination (user_id,family_name,first_name,tel_number,address,status,created_at,updated_at) " +
	        "VALUES (#{userId},#{familyName},#{firstName},#{telNumber},#{address},#{status},#{createdAt},#{updatedAt} )")
